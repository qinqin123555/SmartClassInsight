...
try:
    ...
    try:
        fontC = ImageFont.truetype("msyh.ttc", 20, 0)
    except:
        try:
            fontC = ImageFont.truetype("simsun.ttc", 20, 0)
        except:
...
if __name__ == '__main__':
    img_path = 'D:/Study/深度学习/shenduxuexi/shenduxuexi1/datasets/dataset/images/train/0001002.jpg'
    yolo_file_path = 'D:/Study/深度学习/shenduxuexi/shenduxuexi1/datasets/dataset/labels/train/0001002.txt'
